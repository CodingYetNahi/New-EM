...
export function SiteLayout() {
  ...
  return <div className="min-h-screen bg-white text-slate-800">
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur"><Container className="flex h-18 items-center justify-between py-3">
      <Link to="/" className="flex items-center gap-2 rounded-lg font-bold text-brand-900 focus-ring" aria-label="ExpressMock home"><span className="grid h-10 w-10 place-items-center rounded-xl bg-brand-900 text-lg text-white">E</span><span className="text-xl">Express<span className="text-brand-500">Mock</span></span></Link>
